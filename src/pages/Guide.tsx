...
export default function Guide() {
  ...
  const judul = settings?.panduanJudul || "Panduan Pendaftaran Peserta Didik Baru";
  const deskripsi = settings?.panduanDeskripsi || "Persiapkan dokumen berikut sebelum mulai mengisi formulir pendaftaran.";
  const peringatan = settings?.panduanPeringatan || "Pastikan semua dokumen di-scan atau difoto dengan jelas dan dapat terbaca. Format file yang disarankan adalah JPG dengan ukuran maksimal 2 MB per file.";
