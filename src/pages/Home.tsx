              ...
              <div className="prose prose-lg text-slate-600">
                ...
                <div className="flex items-center gap-4 mt-8">
                  <div className="w-16 h-16 rounded-full bg-slate-200 overflow-hidden">
                    <img src={settings?.fotoKepalaSekolah || "https://www.flaticon.com/free-icon/user_9187604q=80&w=256&auto=format&fit=crop"} alt="Kepala Sekolah" className="w-full h-full object-cover" />
                  </div>
                  <div>
