        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <motion.div
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full font-medium text-lg mb-8 shadow-sm border ${isClosed ? 'bg-white text-red-700 border-slate-200' : 'bg-white text-blue-700 border-slate-200'}`}
            >
            ...
            >
              ...
              <a
                href="#alur"
                className="inline-flex justify-center items-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-8 py-4 rounded-full text-sm font-semibold transition-all shadow-sm hover:shadow-md"
              >
              ...
              <div className="prose prose-lg text-slate-600">
                ...
                <div className="flex items-center gap-4 mt-8">
                  <div className="w-16 h-16 rounded-full bg-slate-200 overflow-hidden">
                    <img src={settings?.fotoKepalaSekolah || "https://images.icon-icons.com/2760/PNG/512/profile_icon_176363.png?q=80&w=256&auto=format&fit=crop"} alt="Kepala Sekolah" className="w-full h-full object-cover" />
                  </div>
                  <div>
      ...
      <section id="alur" className="py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Alur Pendaftaran Murid Baru</h2>
