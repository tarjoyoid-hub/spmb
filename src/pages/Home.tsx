        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              {isClosed ? `Pendaftaran Penerimaan Peserta Didik Baru ${new Date().getFullYear()} Telah Ditutup` : `Pendaftaran Penerimaan Peserta Didik Baru ${new Date().getFullYear()} Telah Dibuka`}
            </motion.div>
